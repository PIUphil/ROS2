...
istream& Student_info::read(istream& in)
{
    ...
    in >> this->name_ >> midterm >> finalterm;

    vector<double> homeworks;
    read_hw(in, homeworks);

    if(!homeworks.empty())
        this->finalScore_ = ::grade(midterm, finalterm, homeworks);
    else
        this->finalScore_ = ::grade(midterm, finalterm, 0.0);
...
Student_info::Student_info()
    : name_(), /*midterm_(0.0), finalterm_(0.0), homeworks_()*/ finalScore_(0.0)
{}
...
double Student_info::score() const
{
